      ...
      body: SafeArea(
        child: ListenableBuilder(
          ...
          builder: (context, _) => RefreshIndicator(
            ...
            child: _loading
                ? const Center(
                    child: CircularProgressIndicator(color: Color(0xFF47D5A6)),
                  )
                : _error != null
                ? _errorState()
        ...
        children: [
          Row(
            children: [
              Text(
                'Current Balance',
                style: _inter(16, FontWeight.w500, _kWhite80),
              ),
              const Spacer(),
            ],
          ),
          ...
          Row(
            children: [
              Text(
                currency.formatValue(total),
                style: _inter(20, FontWeight.w600, _kWhite),
              ),
            ...
            children: [
              Column(
                ...
                children: [
                  Text(
                    'Invested Balance',
                    style: _inter(12, FontWeight.w500, _kWhite80),
                  ),
                  const SizedBox(height: 4),
                  Text(
                    currency.formatValue(invested),
                    style: _inter(15, FontWeight.w600, _kWhite),
                  ),
                ],
              ),
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    currency.formatValue(profit, signed: true),
    ...
    return GestureDetector(
      onLongPress: () => showDialog(
        ...
        builder: (_) => AlertDialog(
          ...
          content: Text(
            'ต้องการลบ $name ออกจากพอร์ตหรือไม่?',
            style: const TextStyle(color: _kWhite80),
          ),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              child: const Text('ยกเลิก', style: TextStyle(color: _kWhite80)),
            ),
            TextButton(
              onPressed: () {
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        child: Text(
                          name,
                          style: _inter(16, FontWeight.w500, _kWhite),
                      ...
                      Text(
                        symbol,
                        style: _inter(10, FontWeight.w400, _kWhite80),
                      ),
                    ],
                  ),
                  const SizedBox(height: 4),
                  Text(
                    'x${qty.toStringAsFixed(qty.truncateToDouble() == qty ? 0 : 5)}',
                    style: _inter(15, FontWeight.w400, _kWhite80),
                  ),
                ],
              ),
            ),
            Column(
              ...
              children: [
                Text(
                  ...
                  style: _inter(15, FontWeight.w400, _kWhite),
                ),
                const SizedBox(height: 4),
                Row(
                  children: [
